  ...
  return (
    <div className='w-full  p-4 '>
      <div className='bg-custom_black text-white  border rounded-2xl shadow-lg pl-10 pr-10 pt-4 pb-4'>
        ...
        <button className='border-white border-2 text-white  mt-4 px-10 py-3 rounded-lg hover:bg-white hover:text-custom_black transition-all duration-300 ease-in-out'>
          See Info
        </button>
      </div>
    </div>
